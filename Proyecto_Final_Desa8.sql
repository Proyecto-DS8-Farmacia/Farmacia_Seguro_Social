...
s.tipo,rs.cant_pedida,s.fecha_expira,f.nombre
...
--Pantalla: Loguearme como Paciente
...
where p.correo_e = 'mariac@gmail.com'
--@CORREO_EPa_HistorialR_paciente 
Pa_HistorialR_paciente 'mariac@gmail.com'
select * from Receta
select * from Paciente
select * from Receta_Sustancia
select * from Sustancia
