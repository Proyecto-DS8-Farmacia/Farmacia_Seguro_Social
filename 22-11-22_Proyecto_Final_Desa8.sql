...
create procedure [dbo].[Registrar]
  @Cedula   varchar(20), @nombre  varchar(20),  @apellido  Varchar(20) ,  @telefono  Varchar(20) ,  @correo  Varchar(20) , @Contraseña Varchar(20) , @tipo Varchar(20), @farma int
  as 

  if( Select cedula From  [Proyecto_Final_Desa8].[dbo].[Usuario] where cedula = @Cedula) = @Cedula
   print'FALSE'
  else
  INSERT INTO Usuario VALUES( @Cedula,@nombre ,@apellido,@telefono,@correo,@Contraseña, @tipo, @farma )
